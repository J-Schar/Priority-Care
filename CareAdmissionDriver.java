    ...
    if (commands.length < 4) {
      ...
      try {
        ...
        if (commands[2].length() != 1) {
          ...
          PatientRecord p = new PatientRecord(gender, age, triage);
          queue.addPatient(p);
        }
      ...
      try {
        switch (command.charAt(0)) {
          ...
          case '1': // [1 <age> <M/F/X> <RED/YELLOW/GREEN>] Add a new patient record
            addPatientRecord(command);
            break;
          case '2': // [2] Show the next patient record
            // this.queue.removeBestRecord();
          ...
          case '3': // [3] See next Patient
            ...
            PatientRecord nextPatient = this.queue.peek();// update this
